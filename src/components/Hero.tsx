    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center">
        ...
        <h1 className="font-display font-black mb-6 leading-[1.05] tracking-tight" style={{ fontSize: 'clamp(2.8rem, 8vw, 7rem)' }}>
          ...
          <br />
          <span className="text-fg">in Your Mind.</span>
        </h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
          {[
            ...
            <div key={stat.label} className="glass rounded-2xl p-4 text-center border border-app-border/5 hover:border-blue-500/30 transition-all duration-300">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-50">
        <div className="w-5 h-8 rounded-full border border-app-border/20 flex items-start justify-center pt-1.5">
          <div className="w-1 h-2 rounded-full bg-fg/60 animate-bounce" />
        </div>
      </div>
    </section>
  );
