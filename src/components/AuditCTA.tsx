...
export default function AuditCTA() {
  ...
  const inputClass = 'w-full px-4 py-3 rounded-xl text-sm text-white placeholder-gray-600 outline-none transition-all duration-300 focus:ring-2 focus:ring-blue-500/30';
  ...
  return (
    <section id="audit" className="py-32 relative overflow-hidden">
      ...
      <div ref={ref} className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        {/* Main card */}
        <div className={`glass-strong rounded-3xl p-10 lg:p-16 border border-white/10 overflow-hidden relative transition-all duration-700 ${inView ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
          {/* Gradient accent top */}
            ...
            <div>
              ...
              {submitted ? (
                <div className="flex items-start gap-4 p-6 rounded-2xl bg-emerald-500/10 border border-emerald-500/20">
                  ...
                  <div>
                    <p className="font-bold text-white mb-1">Audit Request Received!</p>
                    <p className="text-gray-400 text-sm">We'll begin your website audit within 48 hours and send the full report to your inbox.</p>
                  </div>
                </div>
              ) : (
                <form onSubmit={handleAuditSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      <label htmlFor="audit-name" className="block text-xs font-semibold text-gray-500 mb-1.5 uppercase tracking-wide">
                        Your Name *
                      </label>
                      <input
                        id="audit-name"
                    ...
                    <div>
                      <label htmlFor="audit-email" className="block text-xs font-semibold text-gray-500 mb-1.5 uppercase tracking-wide">
                        Email *
                      </label>
                      <input
                        id="audit-email"
                  ...
                  <div>
                    <label htmlFor="audit-url" className="block text-xs font-semibold text-gray-500 mb-1.5 uppercase tracking-wide">
                      Website URL *
                    </label>
              ...
              {auditPoints.map((point, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h4 className="font-display font-bold text-white text-sm mb-2">{point.title}</h4>
