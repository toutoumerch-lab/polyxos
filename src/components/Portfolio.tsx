  ...
  return (
    ...
    >
      ...
      <div className={`h-52 bg-gradient-to-br ${project.mockBg} relative overflow-hidden`}>
        ...
        {/* Mock browser/app UI — sits on an always-dark mockup, so white tints are intentional */}
      ...
      <div className="p-6">
        <div className="flex items-start justify-between mb-3">
          <div>
            ...
            <h3 className="font-display text-lg font-bold text-fg">{project.title}</h3>
          </div>
        </div>
    ...
    <section id="portfolio" className="py-20 md:py-32 relative overflow-hidden">
      ...
      <div ref={ref} className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className={`text-center mt-16 transition-all duration-700 delay-500 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <p className="text-fg-muted mb-6">Want to see more of our work?</p>
          <button
