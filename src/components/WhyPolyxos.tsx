          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {reasons.map((reason, i) => {
              ...
              return (
                <div
                  key={reason.title}
                  className={`glass rounded-2xl p-6 border border-app-border/5 hover:border-app-border/10 transition-all duration-500 hover:-translate-y-1 group ${
                ...
                >
                  ...
                  <h4 className="font-display font-bold text-fg text-sm mb-2">{reason.title}</h4>
                  <p className="text-fg-subtle text-xs leading-relaxed">{reason.description}</p>
                </div>
              );
            })}
          </div>
